      ...
      <AlertDialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[80vw] max-w-[400px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] focus:outline-none text-black ">
        ...
        <div className="flex justify-center gap-[25px]">
          ...
          <AlertDialog.Action asChild>
            <Link
              className=" bg-[#114D0A] text-white focus:shadow-red7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]"
              href={'./auth/signIn'}
            >
              Sign in
            </Link>
